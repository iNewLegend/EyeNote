 ...
 **/
export interface DCommandFunctionComponent<TProps = any, TState = undefined>
...
export type DCommandNewInstanceWithArgs<TState = undefined> = new (
    args: DCommandRegisterArgs
) => CommandBase<TState>;
